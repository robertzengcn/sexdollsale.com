...
$plugin_actions = mb_admin_button(mh_href_link(FILENAME_MAILBEEZ, 'app=load_app&app_path=' . 'config_simulation/admin_application_plugins/simulation_restart.php&app_action=inline'), MAILBEEZ_BUTTON_SIMULATION_RESTART, '', 'link') . '';
