          ...
          <tr>
            <td valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="2">
							<tr>
								...
								<img src="<?php echo MH_CATALOG_SERVER  . MH_DIR_WS_CATALOG ?>mailhive/common/images/been_free.png" width="93" height="82" alt="" border="0" align="left" hspace="1" style="margin-right: 20px;"><h1>Uninstall MailBeez</h1>
