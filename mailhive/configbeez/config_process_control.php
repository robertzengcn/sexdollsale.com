...
define('MAILBEEZ_CONFIG_PROCESS_CONTROL_KILL_FOLDER', MAILBEEZ_CONFIG_TEMPLATE_ENGINE_COMPILE_DIR);
...
// class methods
    ...
    function keys()
    {
        ...
        $keys = array('MAILBEEZ_MAILHIVE_PROCESS_CONTROL', 'MAILBEEZ_MAILHIVE_PROCESS_CONTROL_LOCK_PERIOD', 'MAILBEEZ_MAILHIVE_PROCESS_CONTROL_MEMORY_LIMIT', 'MAILBEEZ_MAILHIVE_PROCESS_CONTROL_INGORE_USER_ABORT');
