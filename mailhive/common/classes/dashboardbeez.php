...
// class methods
    ...
    {
        $installed_modules_list = explode(';', MAILBEEZ_DASHBOARD_INSTALLED_VERSIONS);
    ...
    function update()
    {
        ...
        $updated = preg_replace('/' . $this->module . '\|' . $old_version . '/', $this->module . '|' . $this->version, MAILBEEZ_DASHBOARD_INSTALLED_VERSIONS);

        mh_insert_config_value(array('configuration_title' => 'Installed Modules',
            'configuration_key' => 'MAILBEEZ_DASHBOARD_INSTALLED_VERSIONS',
