...
// class methods
    ...
    {
        $installed_modules_list = explode(';', MAILBEEZ_FILTER_INSTALLED_VERSIONS);
    ...
    function update()
    {
        ...
        $updated = preg_replace('/' . $this->module . '\|' . $old_version . '/', $this->module . '|' . $this->version, MAILBEEZ_FILTER_INSTALLED_VERSIONS);
