...
<div class="mailbeez_main_tabs">
    <link rel="stylesheet" type="text/css" media="print, projection, screen"
          href="<?php echo MH_CATALOG_SERVER . MH_DIR_WS_CATALOG ?>mailhive/common/admin_application_plugins/tabs.css">
    <link rel="stylesheet" type="text/css" media="print, projection, screen"
          href="<?php echo MH_CATALOG_SERVER . MH_DIR_WS_CATALOG ?>mailhive/common/admin_application_plugins/versioncheck.css">
    <ul class="tabs">
