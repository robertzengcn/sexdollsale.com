                ...
                <tr>
                    <td width="100%" valign="top" class="smallText">
                        <div style="border: 1px solid #909090; padding: 30px; margin-top: 10px; background-color: #e9e9e9; min-height: 300px;">
                            <div style="float: right; width: 230px; border: 1px solid #909090; padding: 25px; margin-top: 0px; background-color: #ffffff;  min-height: 260px; background:url(<?php echo MH_CATALOG_SERVER . MH_DIR_WS_CATALOG ?>mailhive/common/images/love128.png) 160px 200px no-repeat #ffffff;	">
                                ...
                                <a href="http://www.mailbeez.com/thank-you/" target="_blank"><img
                                        src="<?php echo MH_CATALOG_SERVER . MH_DIR_WS_CATALOG . 'mailhive/common/languages/' . MH_MAILBEEZ_LOVE_BTN; ?>"
                                        width="98" height="26" alt="" border="0" hspace="20"></a>

                            </div>
                            <img src="<?php echo MH_CATALOG_SERVER . MH_DIR_WS_CATALOG ?>mailhive/common/images/been_free.png"
                                 width="93" height="82" alt="" border="0" align="left" hspace="1"
                                 style="margin-right: 20px;"><?php echo MH_ABOUT; ?><br />

                            <br />

                            <img src="<?php echo MH_CATALOG_SERVER . MH_DIR_WS_CATALOG ?>mailhive/common/images/chat32.png"
                            ...
                            <img src="<?php echo MH_CATALOG_SERVER . MH_DIR_WS_CATALOG ?>mailhive/common/images/star32.png"
                                 width="32" height="32" alt="" border="0" align="absmiddle" hspace="5" vspace="10"> <a
                                href="http://www.trustpilot.com/review/www.mailbeez.com"
                                target="_blank"><?php echo MH_ABOUT_BUTTONS_RATE_READ ?></a> <br />
                            <img src="<?php echo MH_CATALOG_SERVER . MH_DIR_WS_CATALOG ?>mailhive/common/images/star_add32.png"
                                 width="32" height="32" alt="" border="0" align="absmiddle" hspace="5" vspace="10"> <a
