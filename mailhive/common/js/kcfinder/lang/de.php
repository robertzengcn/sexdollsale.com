...
$lang = array(
    ...
    "The uploaded file exceeds {size} bytes." => "Die hochgeladene Datei ueberschreitet die erlaubte Dateigroesse von {size} bytes.",
    ...
    "Missing a temporary folder." => "Temporaerer Ordner fehlt.",
    ...
    "The image is too big and/or cannot be resized." => "Das Bild ist zu gross und/oder kann nicht verkleinert werden.",
    ...
    "Unallowable characters in folder name." => "Der Ordnername enthaelt unerlaubte Zeichen.",
    ...
    "Unallowable characters in file name." => "Der Dateiname enthaelt unerlaubte Zeichen",
    "File name shouldn't begins with '.'" => "Dateinamen sollten nicht mit '.' beginnen.",
    "Are you sure you want to delete this file?" => "Willst Du die Datei wirklich loeschen?",
    "Are you sure you want to delete this folder and all its content?" => "Willst Du wirklich diesen Ordner und seinen gesamten Inhalt loeschen?",
    "Non-existing directory type." => "Der Ordner Typ existiert nicht.",
    "Undefined MIME types." => "Unbekannte MIME Typen.",
    "Fileinfo PECL extension is missing." => "PECL extension fuer Dateiinformationen fehlt",
    "Opening fileinfo database failed." => "Oeffnen der Dateiinfo Datenbank fehlgeschlagen.",
    ...
    "Cannot delete '{file}'." => "Kann Datei '{file}' nicht loeschen.",
    "Cannot delete the folder." => "Der Ordner kann nicht geloescht werden.",
    "Click to remove from the Clipboard" => "Zum entfernen aus der Zwischenablage, hier klicken.",
    "This file is already added to the Clipboard." => "Diese Datei wurde bereits der Zwischenablage hinzugefuegt.",
    "The files in the Clipboard are not readable." => "Die Dateien in der Zwischenablage koennen nicht gelesen werden.",
    "{count} files in the Clipboard are not readable. Do you want to copy the rest?" => "{count} Dateien in der Zwischenablage sind nicht lesbar. Moechtest Du die Uebrigen trotzdem kopieren?",
    "The files in the Clipboard are not movable." => "Die Dateien in der Zwischenablage koennen nicht verschoben werden.",
    "{count} files in the Clipboard are not movable. Do you want to move the rest?" => "{count} Dateien in der Zwischenablage sind nicht verschiebbar. Moechtest Du die Uebrigen trotzdem verschieben?",
    "The files in the Clipboard are not removable." => "Die Dateien in der Zwischenablage koennen nicht geloescht werden.",
    "{count} files in the Clipboard are not removable. Do you want to delete the rest?" => "{count} Dateien in der Zwischenablage koennen nicht geloescht werden. Moechtest Du die Uebrigen trotzdem loeschen?",
    "The selected files are not removable." => "Die ausgewaehlten Dateien koennen nicht geloescht werden.",
    "{count} selected files are not removable. Do you want to delete the rest?" => "{count} der ausgewaehlten Dateien koennen nicht geloescht werden. Moechtest Du die Uebrigen trotzdem loeschen?",
    "Are you sure you want to delete all selected files?" => "Moechtest Du wirklich alle ausgewaehlten Dateien loeschen?",
    "Failed to delete {count} files/folders." => "Konnte {count} Dateien/Ordner nicht loeschen.",
    ...
    "Delete files" => "Loesche Dateien.",
    "Clear the Clipboard" => "Zwischenablage leeren",
    "Are you sure you want to delete all files in the Clipboard?" => "Willst Du wirklich alle Dateien in der Zwischenablage loeschen?",
    "Copy {count} files" => "Kopiere {count} Dateien",
    "Move {count} files" => "Verschiebe {count} Dateien",
    "Add to Clipboard" => "Der Zwischenablage hinzufuegen",
    ...
    "About" => "Ueber",
    "files" => "Dateien",
    "selected files" => "ausgewaehlte Dateien",
    "View:" => "Ansicht:",
    "Show:" => "Zeige:",
    ...
    "Cancel" => "Abbruch",
    "Select" => "Auswaehlen",
    "Select Thumbnail" => "Waehle Miniaturansicht",
    "Select Thumbnails" => "Waehle Miniaturansicht",
    "View" => "Ansicht",
    "Download" => "Download",
    ...
    "Yes" => "Ja",
    "No" => "Nein",
    "You cannot rename the extension of files!" => "Die Umbenennung von Datei-Erweiterungen ist nicht moeglich!",
