...
list($customers_id, $email_address, $mode, $behaviour) = explode('|', base64_decode($_GET['p']));
...
<div class="mailbeez_message">
    ...
    <br />
    <?php if ($msg == 1) { ?>
    you will no longer receive any Email by MailBeez.
    <?php } ?>
    <?php if ($msg == 2) { ?>
    you will no longer receive any Email by MailBeez.
    <br />
    We have already blocked MailBeez for you.
    <?php } ?>
    <?php if ($msg == 3) { ?>
