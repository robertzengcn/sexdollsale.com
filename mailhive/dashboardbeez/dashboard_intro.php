...
class dashboard_intro extends dashboardbeez
{
    ...
    function getOutput()
    {
        $output = '<link rel="stylesheet" type="text/css" media="print, projection, screen" href="' . MH_CATALOG_SERVER . MH_DIR_WS_CATALOG . 'mailhive/dashboardbeez/dashboard_intro/dashboard_intro.css" >';
