...
define('MAILBEEZ_DASHBOARD_VERSIONCHECK_RESULT_UPD_OK', 'All Modules are up to date');
define('MAILBEEZ_DASHBOARD_VERSIONCHECK_RESULT_NEW_OK', 'All Modules are installed');
...
define('MAILBEEZ_DASHBOARD_VERSIONCHECK_MODE_SET_PRODUCTION_DESC', '<strong>Mailbeez is in production mode and live emails will be sent to your customers.</strong>');
