...
class dashboard_review_o_meter extends dashboardbeez
{
    ...
    function getOutput()
    {
        ...
        define('MAILBEEZ_DASHBOARD_REVIEW_O_METER_RATE_LIMIT_1', (int)(6 * MAILBEEZ_DASHBOARD_REVIEW_O_METER_FACTOR));
        define('MAILBEEZ_DASHBOARD_REVIEW_O_METER_RATE_LIMIT_2', (int)(14 * MAILBEEZ_DASHBOARD_REVIEW_O_METER_FACTOR));
        define('MAILBEEZ_DASHBOARD_REVIEW_O_METER_RATE_LIMIT_3', (int)(20 * MAILBEEZ_DASHBOARD_REVIEW_O_METER_FACTOR));
    ...
    <script type="text/javascript"
            src="<?php echo MH_CATALOG_SERVER . MH_DIR_WS_CATALOG ?>mailhive/dashboardbeez/dashboard_review_o_meter/js/gauge.js"></script>
    <script type="text/javascript"
            src="<?php echo MH_CATALOG_SERVER . MH_DIR_WS_CATALOG ?>mailhive/dashboardbeez/dashboard_review_o_meter/js/jquery.gauge.js"></script>
    <?php endif; ?>
    ...
    <div style="margin-left: 0px; border: 0px solid red; position: relative; z-index: 2;min-height: 130px;">
        ...
        <div
            style=" margin-top: 10px;position:relative; background-color: <?php echo $rate_color; ?>; padding: 7px; text-align: center; color: <?php echo $rate_color_text; ?>; font-weight: bold; font-size: 14px;"><?php echo $review_rate_title; ?></div>
    ...
    <?php
        ...
        *
           ...
           <link rel="stylesheet" type="text/css" href="<?php echo MH_CATALOG_SERVER . MH_DIR_WS_CATALOG ?>mailhive/dashboardbeez/dashboard_review_o_meter/css/css.css">
           <link rel="stylesheet" href="<?php echo MH_CATALOG_SERVER . MH_DIR_WS_CATALOG ?>mailhive/dashboardbeez/dashboard_review_o_meter/css/gauge_screen.css" type="text/css"/>
           <!--[if IE]><script type="text/javascript" language="javascript" src="<?php echo MH_CATALOG_SERVER . MH_DIR_WS_CATALOG ?>mailhive/dashboardbeez/dashboard_review_o_meter/js/excanvas.min.js"></script><![endif]-->
           <script language="javascript" type="text/javascript" src="<?php echo MH_CATALOG_SERVER . MH_DIR_WS_CATALOG ?>mailhive/dashboardbeez/dashboard_review_o_meter/js/jQueryRotateCompressed.2.1.js"></script>
           <script language="javascript" type="text/javascript" src="<?php echo MH_CATALOG_SERVER . MH_DIR_WS_CATALOG ?>mailhive/dashboardbeez/dashboard_review_o_meter/js/jgauge-0.3.0.a3.js"></script>
