...
class dashboard_actions extends dashboardbeez
{
    ...
    function getOutput()
    {
        $output = '<link rel="stylesheet" type="text/css" media="print, projection, screen" href="' . MH_CATALOG_SERVER . MH_DIR_WS_CATALOG . 'mailhive/dashboardbeez/dashboard_actions/dashboard_actions.css" >';
