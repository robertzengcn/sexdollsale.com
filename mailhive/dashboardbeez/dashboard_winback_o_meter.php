...
class dashboard_winback_o_meter extends dashboardbeez
{
    ...
    function getOutput()
    {
        ...
        define('MAILBEEZ_DASHBOARD_WINBACK_O_METER_RATE_LIMIT_1', (int)(3 * MAILBEEZ_DASHBOARD_WINBACK_O_METER_FACTOR));
        define('MAILBEEZ_DASHBOARD_WINBACK_O_METER_RATE_LIMIT_2', (int)(7 * MAILBEEZ_DASHBOARD_WINBACK_O_METER_FACTOR));
        define('MAILBEEZ_DASHBOARD_WINBACK_O_METER_RATE_LIMIT_3', (int)(10 * MAILBEEZ_DASHBOARD_WINBACK_O_METER_FACTOR));
        ...
        // Demo Data
        /*
        $winback_email_count = 142;
        $winback_orders_count = 7;
        */
    ...
    <script type="text/javascript"
            src="<?php echo MH_CATALOG_SERVER . MH_DIR_WS_CATALOG ?>mailhive/dashboardbeez/dashboard_winback_o_meter/js/excanvas.min.js"></script><![endif]-->

    <script type="text/javascript"
            src="<?php echo MH_CATALOG_SERVER . MH_DIR_WS_CATALOG ?>mailhive/dashboardbeez/dashboard_winback_o_meter/js/gauge.js"></script>
    <script type="text/javascript"
            src="<?php echo MH_CATALOG_SERVER . MH_DIR_WS_CATALOG ?>mailhive/dashboardbeez/dashboard_winback_o_meter/js/jquery.gauge.js"></script>
    <?php endif; ?>
    ...
    <script type="text/javascript">
        ...
        setTimeout('jQuery("#winback").gauge("setValue", <?php echo sprintf('%.1f', $winback_rate); ?>)', 300);
    </script>
    <div style="margin-left: 0px; border: 0px solid red; position: relative; z-index: 2;min-height: 130px;">

        <div
            style="font-family: Trebuchet MS; font-size: 11px; font-weight: bold; color: #363636; margin-left: 170px; margin-top: 27px;">
            <?php echo sprintf(MAILBEEZ_DASHBOARD_WINBACK_O_METER_RATE_TEXT, $winback_rate)?>
        </div>

        <div
            style=" margin-top: 10px;position:relative; background-color: <?php echo $rate_color; ?>; padding: 7px; text-align: center; color: <?php echo $rate_color_text; ?>; font-weight: bold; font-size: 14px;"><?php echo $winback_rate_title; ?></div>

        <?php if ($winback_show_fix_hint) { ?>
        <div
            style="margin-left: 170px; margin-top: 12px; font-family: Trebuchet MS; font-size: 11px; font-weight: bold; color: #363636;">
    ...
    <div
        style="position: relative; bottom: 3px; font-family: Trebuchet MS; font-size: 11px; font-weight: normal; color: #898989">
    ...
    <?php
        ...
        *
           ...
           <link rel="stylesheet" type="text/css" href="<?php echo MH_CATALOG_SERVER . MH_DIR_WS_CATALOG ?>mailhive/dashboardbeez/dashboard_winback_o_meter/css/css.css">
           <link rel="stylesheet" href="<?php echo MH_CATALOG_SERVER . MH_DIR_WS_CATALOG ?>mailhive/dashboardbeez/dashboard_winback_o_meter/css/gauge_screen.css" type="text/css"/>
           <!--[if IE]><script type="text/javascript" language="javascript" src="<?php echo MH_CATALOG_SERVER . MH_DIR_WS_CATALOG ?>mailhive/dashboardbeez/dashboard_winback_o_meter/js/excanvas.min.js"></script><![endif]-->
           <script language="javascript" type="text/javascript" src="<?php echo MH_CATALOG_SERVER . MH_DIR_WS_CATALOG ?>mailhive/dashboardbeez/dashboard_winback_o_meter/js/jQueryRotateCompressed.2.1.js"></script>
           <script language="javascript" type="text/javascript" src="<?php echo MH_CATALOG_SERVER . MH_DIR_WS_CATALOG ?>mailhive/dashboardbeez/dashboard_winback_o_meter/js/jgauge-0.3.0.a3.js"></script>
