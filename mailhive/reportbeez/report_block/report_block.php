                            ...
                            while ($report = mh_db_fetch_array($report_query)) {
                                ...
                                <tr class="dataTableRow"
                                    ...
                                    <td class="dataTableContent"><?php echo $report['customers_email_address']; ?>
                                        &nbsp;</td>
                                    <td class="dataTableContent"><?php echo constant('BLOCK_SOURCE_' . $report['source']); ?>
                                        &nbsp;</td>
                                    <td class="dataTableContent"><?php echo ($report['simulation'] > 0) ? MAILBEEZ_SIMULATION_TAG : 'PROD'; ?>
                                        &nbsp;</td>
                                </tr>
                                <?php
                            }
