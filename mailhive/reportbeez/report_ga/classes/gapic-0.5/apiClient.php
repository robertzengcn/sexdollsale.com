...
require_once  MH_DIR_FS_CATALOG . 'mailhive/reportbeez/report_ga/classes/gapic-0.5/' . "config.php";
...
require_once  MH_DIR_FS_CATALOG . 'mailhive/reportbeez/report_ga/classes/gapic-0.5/' . 'service/apiModel.php';
require_once  MH_DIR_FS_CATALOG . 'mailhive/reportbeez/report_ga/classes/gapic-0.5/' . 'service/apiService.php';
require_once  MH_DIR_FS_CATALOG . 'mailhive/reportbeez/report_ga/classes/gapic-0.5/' . 'service/apiServiceRequest.php';
require_once  MH_DIR_FS_CATALOG . 'mailhive/reportbeez/report_ga/classes/gapic-0.5/' . 'auth/apiAuth.php';
require_once  MH_DIR_FS_CATALOG . 'mailhive/reportbeez/report_ga/classes/gapic-0.5/' . 'cache/apiCache.php';
require_once  MH_DIR_FS_CATALOG . 'mailhive/reportbeez/report_ga/classes/gapic-0.5/' . 'io/apiIO.php';
require_once (MH_DIR_FS_CATALOG . 'mailhive/reportbeez/report_ga/classes/gapic-0.5/' . 'service/apiMediaFileUpload.php');
