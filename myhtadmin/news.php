...
//--></script>' .
		...
		foreach ($languages as $i => $lang) {
			echo
						...
						'</tr>' .
						'<tr class="dataTableRow">' .
                            '<td class="dataTableContent" align="left">' . 'News_title' . '</td>' .
                            '<td class="dataTableContent" align="left" colspan="4"><input name="news_title" type="text"></td>' .
                            '<td class="dataTableContent" align="left">&nbsp;</td>' .
                        '</tr>' .
                        '<tr class="dataTableRow">' .
                            '<td class="dataTableContent" align="left">' . 'News_keywords' . '</td>' .
                            '<td class="dataTableContent" align="left" colspan="4"><input name="news_keywords" type="text"></td>' .
                            '<td class="dataTableContent" align="left">&nbsp;</td>' .
                        '</tr>' .
						'<tr class="dataTableRow">' .
                            '<td class="dataTableContent" align="left">' . 'News_description' . '</td>' .
                            '<td class="dataTableContent" align="left" colspan="4"><input name="news_description" type="text" style="width:50%"></td>' .
                            '<td class="dataTableContent" align="left">&nbsp;</td>' .
                        '</tr>' .
						'<tr class="dataTableRow">' .
   ...
   //修改
      	...
      	echo "<input type='hidden' name='news_title' value='".$news_title."'>";
      	echo "<input type='hidden' name='news_description' value='".$news_description."'>";
      	echo "<input type='hidden' name='news_keywords' value='".$news_keywords."'>";
