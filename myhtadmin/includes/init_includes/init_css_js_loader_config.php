...
if (defined('CSS_JS_LOADER_VERSION')) // does not exist prior to v2.0.0
{
	...
	while ($css_js_loader_version != $current_version)
	{
		switch ($css_js_loader_version)
		{
			...
			case '3.0.1':
				// perform upgrade
				if (file_exists(DIR_WS_INCLUDES . 'installers/css_js_loader/3_0_2.php'))
				{
					include_once(DIR_WS_INCLUDES . 'installers/css_js_loader/3_0_2.php');
					$messageStack->add('Updated CSS JS Loader to v3.0.2');
					$css_js_loader_version = '3.0.2';
					break;
				}
				else
				{
					break 2;
                        ...
                        case '3.0.2':
				// perform upgrade
				if (file_exists(DIR_WS_INCLUDES . 'installers/css_js_loader/3_0_3.php'))
				{
					include_once(DIR_WS_INCLUDES . 'installers/css_js_loader/3_0_3.php');
					$messageStack->add('Updated CSS JS Loader to v3.0.3');
					$css_js_loader_version = '3.0.3';
					break;
				}
				else
				{
					break 2;
                        ...
                        case '3.0.3':
				// perform upgrade
				if (file_exists(DIR_WS_INCLUDES . 'installers/css_js_loader/3_0_4.php'))
				{
					include_once(DIR_WS_INCLUDES . 'installers/css_js_loader/3_0_4.php');
					$messageStack->add('Updated CSS JS Loader to v3.0.4');
					$css_js_loader_version = '3.0.4';
					break;
				}
				else
				{
					break 2;
                        ...
                        case '3.0.4':
				// perform upgrade
				if (file_exists(DIR_WS_INCLUDES . 'installers/css_js_loader/3_0_5.php'))
				{
					include_once(DIR_WS_INCLUDES . 'installers/css_js_loader/3_0_5.php');
					$messageStack->add('Updated CSS JS Loader to v3.0.5');
					$css_js_loader_version = '3.0.5';
					break;
				}
				else
				{
			...
			default:
				$css_js_loader_version = $current_version;
				break 2;
		}
	}
}
