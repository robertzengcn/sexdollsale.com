...
';
$content .= '<div class="fb-like" data-href="'.$pageurl.'" data-send="'.$send.'" data-width="'.$width.'" data-layout="button_count" data-show-faces="'.$faces.'"></div><br><br><iframe src="//www.facebook.com/plugins/subscribe.php?href='.$profileurl.'&amp;layout=button_count&amp;show_faces='.$faces.'&amp;colorscheme=light&amp;font&amp;width=450" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:'.$width.'px;" allowTransparency="true"></iframe>';
   $content .= '</div>';
?>