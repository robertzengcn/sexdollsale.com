 ...
 */
  ...
  if (strtolower(IMAGE_USE_CSS_BUTTONS) == 'yes') {
    $content .= '<ul>';
    $content .= '<li>'.zen_draw_input_field('keyword', '', 'size="18" maxlength="100" ') .'</li>';
    $content .= '<li>'.zen_image_submit (BUTTON_IMAGE_SEARCH,HEADER_SEARCH_BUTTON).'</li>';
    $content .= '<li><a href="' . zen_href_link(FILENAME_ADVANCED_SEARCH) . '">' . BOX_SEARCH_ADVANCED_SEARCH . '</a></li>';
    $content .= '</ul>';
  } else {
