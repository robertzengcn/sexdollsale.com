...
// categories_image
  if ($categories_image = zen_get_categories_image($current_category_id)) {
    ...
    echo '<div id="categoryImgListing" class="categoryImg'.$product_listing_category_image_alignment_class.'">'.zen_image(DIR_WS_IMAGES . $categories_image, '', SUBCATEGORY_IMAGE_TOP_WIDTH, SUBCATEGORY_IMAGE_TOP_HEIGHT).'</div>';
  }
} // categories_image
?>
