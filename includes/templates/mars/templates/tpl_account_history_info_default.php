...
<?php
  for ($i=0, $n=sizeof($order->totals); $i<$n; $i++) {
    $total = ($i == $n-1) ? "total" : "";
?>
     <div class="amount larger forward <?php echo $total; ?>"><?php echo $order->totals[$i]['text'] ?></div>
     <div class="lineTitle larger forward <?php echo $total; ?>"><?php echo $order->totals[$i]['title'] ?></div>
<br class="clearBoth" />
<?php
  }
?>
