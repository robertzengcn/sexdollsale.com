 ...
 */
?>
<div class="centerColumn selectBoxContent" id="indexProductList">
...
// categories_image
  if ($categories_image = zen_get_categories_image($current_category_id)) {
    ...
    // Setting the Product Listing Category Image Class 
    switch ($product_listing_options->fields['product_listing_category_image_alignment']) {
      case '2': $product_listing_category_image_alignment_class = " categoryImgCenter"; break;
      case '3': $product_listing_category_image_alignment_class = " categoryImgRight"; break;    
      default: $product_listing_category_image_alignment_class = ""; break;
    }    
    echo '<div id="categoryImgListing" class="categoryImg'.$product_listing_category_image_alignment_class.'">'.zen_image(DIR_WS_IMAGES . $categories_image, '', CATEGORY_ICON_IMAGE_WIDTH, CATEGORY_ICON_IMAGE_HEIGHT).'</div>';
  }
} // categories_image
?>
...
<div id="indexProductListFilterCont">
<?php
...
<?php
  ...
  if ($do_filter_list) {
    echo '<div id="manufacturersControl">' .zen_draw_pull_down_menu('filter_id', $options, (isset($_GET['filter_id']) ? $_GET['filter_id'] : ''), 'onchange="this.form.submit()"') .'</div>';
  }  

  // draw alpha sorter
  echo '<div id="sortControl">';
  ...
  if (defined('PRODUCT_LISTING_LAYOUT_STYLE_CUSTOMER') and PRODUCT_LISTING_LAYOUT_STYLE_CUSTOMER == '1') {
    ...
    echo '<label class="inputLabelView">' .TEXT_VIEW . '</label>';
  }
?>
</form>
</div>
