...
<?php $products_model = str_replace("<br />", "&nbsp;", $products_model); ?>
...
<h3 id="reviewsWriteReviewer"><?php echo SUB_TITLE_FROM.' '. zen_output_string_protected($customer->fields['customers_firstname'] . ' ' . $customer->fields['customers_lastname']); ?></h3>
</div>
...
<div class="last buttonRow forward"><?php echo zen_image_submit(BUTTON_IMAGE_SUBMIT, BUTTON_SUBMIT_ALT); ?></div>
<br class="clearBoth" />
