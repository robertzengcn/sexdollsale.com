  <fieldset class="fec-fieldset fec-shopping-cart-fieldset">
    ...
    <div class="buttonRow forward fec-shopping-cart-btn"><?php echo '<a href="' . zen_href_link(FILENAME_SHOPPING_CART, '', 'SSL') . '">' . zen_image_button(BUTTON_IMAGE_EDIT_SMALL, BUTTON_EDIT_SMALL_ALT) . '</a>'; ?></div>
    <br class="clearBoth" />
    ...
    <?php  } //endif flagAnyOutOfStock ?>
          <div class="fec-table-items fec-shopping-cart">
