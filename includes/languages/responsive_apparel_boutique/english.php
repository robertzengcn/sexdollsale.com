...
// END: moved to meta_tags.php
  ...
  define('FOOTER_TEXT_BODY', 'Copyright &copy; ' . date('Y') . ' <a href="http://www.ebayst.com" target="_blank">' . STORE_NAME . '</a>');
...
// Global entries for the <html> tag
  define('HTML_PARAMS','dir="ltr" lang="en" xmlns:fb="http://ogp.me/ns/fb#"');
