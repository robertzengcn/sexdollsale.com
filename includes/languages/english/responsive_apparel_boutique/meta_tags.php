...
// page title
define('TITLE', 'Aniga Doll Online Stores');

// Site Tagline
define('SITE_TAGLINE', 'Sale sex doll at cheap price with free shipping');

// Custom Keywords
define('CUSTOM_KEYWORDS', 'sex doll, silicone doll, love doll');
