 ...
 * @version $Id: german.php 652 2011-01-19 00:37:37Z frank18 $
 */
...
// END: moved to meta_tags.php
  ...
  define('FOOTER_TEXT_BODY', 'Copyright &copy; ' . date('Y') . ' <a href="' . zen_href_link(FILENAME_DEFAULT) . '" target="_blank"><strong>' . STORE_NAME . '</strong></a>. Präsentiert von <strong><a href="http://loxdesign.net" target="_blank">LoxDesign</a></strong>');
