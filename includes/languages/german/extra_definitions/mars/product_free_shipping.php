...
// +----------------------------------------------------------------------+
// | Translator:           frank18                                  |
// | Date of Translation:  2010-06-19                                       |
// | Homepage:             www.frnt.org                                |
// +----------------------------------------------------------------------+
...
define('TEXT_PRODUCT_FREE_SHIPPING_ICON', zen_image(DIR_WS_TEMPLATE_IMAGES . 'always-free-shipping_de.png', 'Immer versandkostenfrei')); // for an image or comment out to use another
?>
