...
class Configuration {
	//在线订单操作
	const ORDERS_OPERATION_URLS = MODULE_SHIPPING_DSF_ORDERS_OPERATION_URLS;

	//在线订单工具
	const ORDERS_TOOLS_URLS = MODULE_SHIPPING_DSF_ORDERS_TOOLS_URLS;

	const AUTHTOKEN = MODULE_SHIPPING_DSF_AUTHTOKEN;
