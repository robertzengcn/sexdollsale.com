...
// Set expiration time, default is 1200 secs (20 mins)
  ...
  if ($n_guests >= 1) $textstring .= "<strong>". $n_guests ."</strong>" . $word_guest;

  $textstring .= $word_and;
  if ($n_members >= 1) $textstring .= "<strong>". $n_members ."</strong>". $word_member;

  $textstring .= '&nbsp;' . BOX_WHOS_ONLINE_ONLINE;

  $textstring = explode("<br />", $textstring);
