...
//bof - Ref_nofollow_on_ez module - Jaycode
				$page_query_list_sidebox[$rows]['relnofollow'] = ($page_query->fields['status_rel_nofollow'] == '1' ? ' rel="nofollow"' : '');
//eof - Ref_nofollow_on_ez module - Jaycode
        $page_query->MoveNext();
      }
