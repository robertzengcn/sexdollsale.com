...
$MAX_DISPLAY_PRODUCTS_FEATURED_PRODUCTS = $_GET['limit'];
if($_GET['limit']==''){
   $MAX_DISPLAY_PRODUCTS_FEATURED_PRODUCTS=MAX_DISPLAY_PRODUCTS_FEATURED_PRODUCTS;
   $limit=MAX_DISPLAY_PRODUCTS_FEATURED_PRODUCTS;
}else{
 $limit =$_GET['limit'];
 }
...
$featured_products_query_raw = "SELECT  p.products_id, p.products_type, pd.products_name, p.products_image, p.products_price, p.products_tax_class_id, p.products_date_added,  p.products_model, p.products_quantity, p.products_weight, p.product_is_call,
                                  p.product_is_always_free_shipping, p.products_qty_box_status
                                  FROM " . TABLE_PRODUCTS . " p, " .TABLE_PRODUCTS_DESCRIPTION . " pd
                                  WHERE p.products_status = 1  and p.products_ordered > 0
